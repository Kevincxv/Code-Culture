...
export default function sideBar() {
  ...
  return (
    <div className="relative">
      ...
      <button onClick={toggleSidebar} className={`absolute ${isSidebarOpen ? 'top-[270px] left-[360px]' : 'top-[270px] left-[20px]' } bg-white rounded-full p-2 transition-width duration-300 ease-in-out`}>
      </button>
    </div>
  )
}